...
require 'admin/memorials_controller'

# Re-raise errors caught by the controller.
class Admin::MemorialsController; def rescue_action(e) raise e end; end

class Admin::MemorialsControllerTest < Test::Unit::TestCase
  fixtures :memorials

  def setup
    @controller = Admin::MemorialsController.new
