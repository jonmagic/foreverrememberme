...
require 'memorial_controller'

# Re-raise errors caught by the controller.
class MemorialController; def rescue_action(e) raise e end; end

class MemorialControllerTest < Test::Unit::TestCase
  fixtures :memorials

  def setup
    @controller = MemorialController.new
